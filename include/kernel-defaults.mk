...
LINUX_CAT:=$(if $(findstring .xz,$(LINUX_SOURCE)),xzcat,$(STAGING_DIR_HOST)/bin/libdeflate-gzip -dc)
...
define Kernel/CompileModules/Default
	...
	+$(KERNEL_MAKE) $(or $(KERNELNAME),all) modules
...
define Kernel/CopyImage
	cmp -s $(LINUX_DIR)/vmlinux $(KERNEL_BUILD_DIR)/vmlinux$(1).debug || { \
		...
		$(foreach k, \
			$(or $(KERNEL_IMAGES),$(filter-out vmlinux dtbs,$(KERNELNAME))), \
...
define Kernel/CompileImage/Default
	...
	+$(KERNEL_MAKE) $(KERNEL_MAKEOPTS_IMAGE) $(or $(KERNELNAME),all)
