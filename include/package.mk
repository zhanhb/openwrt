...
PKG_BUILD_DIR ?= $(BUILD_DIR)/$(BUILD_VARIANT:%=$(PKG_NAME)-%/)$(PKG_NAME)$(PKG_VERSION:%=-%)
...
STAMP_INSTALLED:=$(STAGING_DIR)/stamp/.$(PKG_DIR_NAME)$(BUILD_VARIANT:%=.%)_installed

STAGING_FILES_LIST:=$(PKG_DIR_NAME)$(BUILD_VARIANT:%=.%).list
