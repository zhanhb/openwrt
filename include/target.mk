...
define Profile
  ...
  DUMPINFO += \
	...
	$(if $(strip $(PACKAGES)),echo "Target-Profile-Packages: $(PACKAGES)";) \
...
GENERIC_BACKPORT_DIR := $(or $(wildcard $(GENERIC_PLATFORM_DIR)/backport-$(KERNEL_PATCHVER)),$(GENERIC_PLATFORM_DIR)/backport)
GENERIC_PATCH_DIR := $(or $(wildcard $(GENERIC_PLATFORM_DIR)/pending-$(KERNEL_PATCHVER)),$(GENERIC_PLATFORM_DIR)/pending)
GENERIC_HACK_DIR := $(or $(wildcard $(GENERIC_PLATFORM_DIR)/hack-$(KERNEL_PATCHVER)),$(GENERIC_PLATFORM_DIR)/hack)
GENERIC_FILES_DIR := $(foreach dir,$(wildcard $(GENERIC_PLATFORM_DIR)/files $(GENERIC_PLATFORM_DIR)/files-$(KERNEL_PATCHVER)),"$(dir)")

__config_name_list = $(1)/config-$(KERNEL_PATCHVER) $(1)/config-default
__config_list = $(firstword $(wildcard $(call __config_name_list,$(1))))
find_kernel_config=$(or $(__config_list),$(lastword $(__config_name_list)))
