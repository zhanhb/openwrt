...
VERSION_NUMBER:=$(or $(call qstrip,$(CONFIG_VERSION_NUMBER)),22.03-SNAPSHOT)
VERSION_CODE:=$(or $(call qstrip,$(CONFIG_VERSION_CODE)),$(REVISION))
VERSION_REPO:=$(or $(call qstrip,$(CONFIG_VERSION_REPO)),https://downloads.openwrt.org/releases/22.03-SNAPSHOT)
